...
class AuthenticateTest(TestCase):
    ...
    def test_sends_assertion_to_mozilla_with_domain(
        self, mock_post
    ):
    ...
    def test_returns_none_if_response_errors(
        self, mock_post
    ):
    ...
    def test_returns_none_if_status_not_okay(
        self, mock_post
    ):
    ...
    def test_finds_existing_user_with_email(
        self, mock_post
    ):
...
class GetUserTest(TestCase):
    ...
    def test_gets_user_by_email(self):
        ...
        other_user = User(email='other@user')
